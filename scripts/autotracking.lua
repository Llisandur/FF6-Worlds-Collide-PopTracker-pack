...
function updateEventsAndBosses(segment)
  ...
  if Tracker:FindObjectForCode("TzenHouse").Active then
    forceTreasureLocation("@Collapsing House/First Floor Top Right")
    forceTreasureLocation("@Collapsing House/First Floor Middle")
    forceTreasureLocation("@Collapsing House/First Floor Top Left")
    forceTreasureLocation("@Collapsing House/First Floor Left")
    forceTreasureLocation("@Collapsing House/First Floor Bottom Left")
    forceTreasureLocation("@Collapsing House/Basement Bottom")
    forceTreasureLocation("@Collapsing House/Basement Left")
    forceTreasureLocation("@Collapsing House/Basement Right")
  end
...
updateTreasureLocation(segment, "@Darill's Tomb/Basement 2 Southeast", 0x7E1E53, 0x10)
updateTreasureLocation(segment, "@Darill's Tomb/Basement 2 Southwest", 0x7E1E53, 0x20)
updateTreasureLocation(segment, "@Darill's Tomb/Basement 3 Center", 0x7E1E53, 0x40)
updateTreasureLocation(segment, "@Darill's Tomb/Basement 3 Right", 0x7E1E53, 0x80)
updateTreasureLocation(segment, "@Darill's Tomb/Pre-Boss Room Left", 0x7E1E54, 0x02)
updateTreasureLocation(segment, "@Darill's Tomb/Pre-Boss Room Right", 0x7E1E54, 0x01)
...
updateTreasureLocation(segment, "@Fanatics' Tower/Seventeenth Floor", 0x7E1E56, 0x20)
updateTreasureLocation(segment, "@Fanatics' Tower/Twenty-sixth Floor", 0x7E1E56, 0x40)
updateTreasureLocation(segment, "@Fanatics' Tower/Thirty-fifth Floor", 0x7E1E56, 0x80)
updateTreasureLocation(segment, "@Fanatics' Tower/Seventh Floor", 0x7E1E57, 0x02)
updateTreasureLocation(segment, "@Fanatics' Tower/Eighth Floor", 0x7E1E56, 0x10)
...
updateTreasureLocation(segment, "@Owzer's House/Pot", 0x7E1E48, 0x04)
updateTreasureLocation(segment, "@Owzer's Basement/Left Door", 0x7E1E5A, 0x20)
updateTreasureLocation(segment, "@Owzer's Basement/Door Trio", 0x7E1E60, 0x04)
...
updateTreasureLocation(segment, "@Returners' Hideout/Banon's Room", 0x7E1E46, 0x01)
updateTreasureLocation(segment, "@Returners' Hideout/Bedroom", 0x7E1E45, 0x04)
updateTreasureLocation(segment, "@Returners' Hideout/Main Room Pot", 0x7E1E45, 0x02)
updateTreasureLocation(segment, "@Returners' Hideout/North Room Bottom Left", 0x7E1E45, 0x40)
updateTreasureLocation(segment, "@Returners' Hideout/North Room Bottom Right", 0x7E1E45, 0x80)
updateTreasureLocation(segment, "@Returners' Hideout/North Room Upper Left", 0x7E1E45, 0x20)
updateTreasureLocation(segment, "@Returners' Hideout/North Room Bucket", 0x7E1E45, 0x08)
updateTreasureLocation(segment, "@Returners' Hideout/North Room Pot", 0x7E1E45, 0x10)
updateTreasureLocation(segment, "@Returners' Hideout/North Room Secret Room", 0x7E1E46, 0x02)
...
updateTreasureLocation(segment, "@ South Figaro/Old Man's Bucket", 0x7E1E43, 0x40)
updateTreasureLocation(segment, "@ South Figaro/Secret Path Clock", 0x7E1E43, 0x80)
updateTreasureLocation(segment, "@South Figaro Cave/Eastern Passage WoB", 0x7E1E60, 0x80)
updateTreasureLocation(segment, "@South Figaro Cave/Southwest Passage WoB", 0x7E1E60, 0x40)
updateTreasureLocation(segment, "@South Figaro Cave/Eastern Bridge WoB", 0x7E1E61, 0x01)
updateTreasureLocation(segment, "@ South Figaro Cave/Eastern Passage WoR", 0x7E1E4C, 0x02)
updateTreasureLocation(segment, "@ South Figaro Cave/Southwest Passage WoR", 0x7E1E42, 0x04)
updateTreasureLocation(segment, "@ South Figaro Cave/Eastern Bridge WoR", 0x7E1E42, 0x08)
...
updateTreasureLocation(segment, "@Collapsing House/First Floor Top Right", 0x7E1E51, 0x40)
updateTreasureLocation(segment, "@Collapsing House/First Floor Middle", 0x7E1E52, 0x02)
updateTreasureLocation(segment, "@Collapsing House/First Floor Top Left", 0x7E1E51, 0x80)
updateTreasureLocation(segment, "@Collapsing House/First Floor Left", 0x7E1E52, 0x01)
updateTreasureLocation(segment, "@Collapsing House/First Floor Bottom Left", 0x7E1E52, 0x04)
updateTreasureLocation(segment, "@Collapsing House/Basement Bottom", 0x7E1E52, 0x20)
updateTreasureLocation(segment, "@Collapsing House/Basement Left", 0x7E1E52, 0x10)
updateTreasureLocation(segment, "@Collapsing House/Basement Right", 0x7E1E52, 0x08)
end
